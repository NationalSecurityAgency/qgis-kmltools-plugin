...
PY_FILES = kmltools.py __init__.py importKml.py htmlExpansionDialog.py htmlParser.py htmlExpansionAlgorithm.py exportKmz.py provider.py settings.py convertGroundOverlays.py
